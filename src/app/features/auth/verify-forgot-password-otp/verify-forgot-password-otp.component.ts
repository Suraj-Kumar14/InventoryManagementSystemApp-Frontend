  ...
  template: `
    <div class="auth-card animate-fade-in">
      <div class="auth-header">
        ...
        <p class="auth-subtitle">Enter the password reset code sent to <strong>{{ email() }}</strong></p>
      </div>
...
export class VerifyForgotPasswordOtpComponent implements OnInit, OnDestroy {
  ...
  resend(): void {
    ...
    this.auth.forgotPassword(this.email()).subscribe({
      next: () => {
        ...
        this.toast.success('A new password reset code has been sent to your email.');
        this.startCountdown();
      },
      error: err => {
        this.resending.set(false);
