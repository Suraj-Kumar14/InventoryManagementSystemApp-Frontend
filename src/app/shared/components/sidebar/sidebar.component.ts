...
export class SidebarComponent {
  ...
  private readonly menuItems: MenuItem[] = [
    ...
    { label: 'Dashboard', route: '/dashboard/manager', roles: [UserRole.INVENTORY_MANAGER], iconClass: 'bi bi-speedometer2' },
    { label: 'Dashboard', route: '/dashboard/officer', roles: [UserRole.PURCHASE_OFFICER], iconClass: 'bi bi-cart3' },
    { label: 'Dashboard', route: '/dashboard/staff', roles: [UserRole.WAREHOUSE_STAFF], iconClass: 'bi bi-building' },
    ...
    },
    {
      ...
      roles: [UserRole.ADMIN, UserRole.INVENTORY_MANAGER, UserRole.WAREHOUSE_STAFF],
      iconClass: 'bi bi-search',
    },
    {
      label: 'Stock',
      route: '/inventory/stock',
      roles: [UserRole.INVENTORY_MANAGER, UserRole.ADMIN],
    ...
    },
    {
      label: 'Alerts',
      route: '/alerts',
      roles: [UserRole.INVENTORY_MANAGER, UserRole.ADMIN, UserRole.WAREHOUSE_STAFF, UserRole.PURCHASE_OFFICER],
    ...
    },
    {
      ...
      roles: [UserRole.PURCHASE_OFFICER, UserRole.ADMIN, UserRole.INVENTORY_MANAGER],
    ...
    },
    {
      ...
      roles: [UserRole.PURCHASE_OFFICER],
      iconClass: 'bi bi-plus-square',
    },
    {
      label: 'Suppliers',
      route: '/suppliers',
      roles: [UserRole.PURCHASE_OFFICER, UserRole.ADMIN],
    ...
    },
    {
      label: 'Reports',
      route: '/reports',
      roles: [UserRole.ADMIN, UserRole.INVENTORY_MANAGER, UserRole.PURCHASE_OFFICER],
      iconClass: 'bi bi-graph-up-arrow',
    },
    {
