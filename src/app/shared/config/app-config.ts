...
export const API_ENDPOINTS = {
  ...
  MOVEMENTS: {
    ...
    RECENT: '/api/v1/movements/recent',
  ...
  REPORTS: {
    ROOT: '/api/v1/reports',
    TOTAL_VALUE: '/api/v1/reports/totalValue',
    BY_WAREHOUSE: '/api/v1/reports/byWarehouse',
    TURNOVER: '/api/v1/reports/turnover',
    LOW_STOCK: '/api/v1/reports/lowStock',
    WAREHOUSE_REPORTS: '/api/v1/reports/warehouse/reports',
    TOP_MOVING: '/api/v1/reports/topMoving',
    SLOW_MOVING: '/api/v1/reports/slowMoving',
    DEAD_STOCK: '/api/v1/reports/deadStock',
    PO_SUMMARY: '/api/v1/reports/poSummary',
    GENERATE_REPORT: '/api/v1/reports/generateReport',
    INVENTORY_VALUATION: '/api/v1/reports/totalValue',
    STOCK_SUMMARY: '/api/v1/reports/generateReport',
    PRODUCT_STOCK: '/api/v1/reports/totalValue',
    WAREHOUSE_STOCK: '/api/v1/reports/warehouse/reports',
    OVERSTOCK: '/api/v1/reports/overstock',
    INVENTORY_MOVEMENT_SUMMARY: '/api/v1/reports/generateReport',
    MOVEMENTS: '/api/v1/reports/movements',
    PURCHASE_SUMMARY: '/api/v1/reports/poSummary',
    PURCHASE_ORDER_SUMMARY: '/api/v1/reports/poSummary',
    PURCHASE_ORDER_DETAIL: (id: number) => `/api/v1/reports/purchase-orders/${id}`,
    CANCELLED_PURCHASE_ORDERS: '/api/v1/reports/purchase-orders/cancelled',
    REJECTED_PURCHASE_ORDERS: '/api/v1/reports/purchase-orders/rejected',
    SUPPLIER_PERFORMANCE: '/api/v1/reports/purchase/supplier-performance',
    SUPPLIER_PERFORMANCE_BY_ID: (supplierId: number) => `/api/v1/reports/purchase/supplier-performance/${supplierId}`,
    PAYMENT_SUMMARY: '/api/v1/reports/payments/summary',
    PAYMENT_BILLING: '/api/v1/reports/payments/billing',
    ALERT_SUMMARY: '/api/v1/reports/alerts/summary',
    EXECUTIVE_DASHBOARD: '/api/v1/reports/dashboard/executive',
    MY_DASHBOARD: '/api/v1/reports/dashboard',
    SNAPSHOT_RUN: '/api/v1/reports/snapshots/run',
    SNAPSHOT_TAKE: '/api/v1/reports/snapshots/take',
  ...
  PAYMENTS: {
    ...
    SPLIT_PLAN: '/api/v1/payments/split-plan',
    RAZORPAY_INITIATE: '/api/v1/payments/razorpay/initiate',
    RAZORPAY_VERIFY: '/api/v1/payments/razorpay/verify',
    RAZORPAY_FAILURE: '/api/v1/payments/razorpay/failure',
    RAZORPAY_CANCEL: '/api/v1/payments/razorpay/cancel',
  },
} as const;
